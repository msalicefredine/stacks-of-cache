...
- (void)applicationDidEnterBackground:(UIApplication *)application {
	...
	[defaults setInteger:this.foodEaten forKey:@"foodEaten"];
	[defaults setInteger:this.foodThrownAway forKey:@"foodThrownAway"];
	[defaults setObject:this.listOfFood forKey:@"listOfFood"];
}
